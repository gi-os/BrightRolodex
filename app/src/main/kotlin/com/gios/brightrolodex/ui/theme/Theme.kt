package com.gios.brightrolodex.ui.theme
 ...
 *
 * `scrim` and `matte` survive from the app this was ported out of and are used here for the
 * FIND sheet and for the dimmed area outside a zoomed face, which is the same problem: chrome
 * that has to stay legible over something already drawn.
 */
...
@Composable
fun BrightRolodexTheme(content: @Composable () -> Unit) {
